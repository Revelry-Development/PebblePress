...
static void menu_draw_header_callback(GContext* ctx, const Layer *cell_layer, uint16_t section_index, void *data) {
  ...
  switch (section_index) {
    case 0:
      ...
      menu_cell_basic_header_draw(ctx, cell_layer, "Brew Times");
      break;

    case 1:
      menu_cell_basic_header_draw(ctx, cell_layer, "Start");
      break;
  }
}
    ...
    case 0:
      ...
      switch (cell_index->row) {
        case 0:
          ...
          menu_cell_basic_draw(ctx, cell_layer, "Stir Time", "2:00", NULL);
          break;
    ...
    case 1:
      switch (cell_index->row) {
        case 0:
          ...
          menu_cell_title_draw(ctx, cell_layer, "Brew Now!");
          break;
      }
  }
}
